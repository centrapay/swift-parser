...
class TagFactory {
  ...
  constructor () {
    this.tagMap = [
      ...
      TagStatementNumber,
      TagDebitAndCreditFloorLimitIndicator,
...
class TagDebitAndCreditFloorLimitIndicator extends Tag {
  ...
  accept(visitor) {
    visitor.visitDebitFloorLimitIndicator;
  }
}
...
class TagDateTimeIndication extends Tag {
  ...
  accept(visitor){
    visitor.visitDateTimeIndication;
  }
}
...
class TagNumberAndSumOfEntries extends Tag {
  ...
  accept(visitor){
    visitor.visitFirstNumberAndSumOfEntries(this);
  }
}
